    ...
    return(
        <div className={styles.MyPage1}>
            <div className={styles.UserBox}>
                ...
                <img src="/images/myPage-images/editImg.png" alt="UserImg"/>
            </div>
            ...
            <div>
                <div reviewBoxAll>
                    <div className={styles.reviewBox}> 
                        <img className={styles.reviewImgs} src="/images/food/hamburger/hamburger (1).jpg" alt='reviewImg'/>
                        <h5>햄버거 맛집</h5>
                    ...
                    <div className={styles.reviewBox}> 
                        <img className={styles.reviewImgs} src="/images/food/chinesefood/chinesefood (1).jpg" alt='reviewImg'/>
                        <h5>중식 맛집</h5>
                        <img src="/images/myPage-images/5star.png" alt='5star'/>
                        <br/>
